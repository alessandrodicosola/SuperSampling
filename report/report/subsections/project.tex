...
% 3: scale
    \begin{figure}
        \begin{subfigure}{0.5\textwidth}
            \centering
            \includegraphics[scale=#3]{#2-input}
            \caption{Input}
        \end{subfigure}
        \begin{subfigure}{0.5\textwidth}
            \centering
            \includegraphics[scale=#3]{#2-gt}
            \caption{Ground truth.}
        \end{subfigure}
        \begin{subfigure}{0.5\textwidth}
            \centering
            \includegraphics[scale=#3]{#2-bicubic}
            \caption{Bicubic.}
        \end{subfigure}
        \begin{subfigure}{0.5\textwidth}
            \centering
            \includegraphics[scale=#3]{#2-output}
            \caption{Output.}
        \end{subfigure}
...
The network is able to reconstruct sharp edges but unable to restore all the details from the original image [\Cref{project:test-Urban100},\Cref{project:test-Manga109},\Cref{project:test-Set5},\Cref{project:test-Set14},\Cref{project:test-BSDS100},\Cref{project:test-historical}]
